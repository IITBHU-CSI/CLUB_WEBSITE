...
export default function HomeVerticals() {
  ...
  return (
    ...
    >
      <h2 style={{ textAlign: "center", marginBottom: 28, fontSize: 30, fontWeight: 700 }}>
        Our Club Verticals !
      </h2>

      <div style={{ position: "relative", width: 700, height: 620, margin: "0 auto" }}>
        {verticals.map((v, i) => {
          return (
            <div
              key={v.label}
              ...
              style={{
                ...
                height: iconSize,
                borderRadius: "50%",
                background: selected === i ? "#fdf5e6" : "#111",
                border: "4px solid #fdf5e6",
                color: selected === i ? "#111" : "#fdf5e6",
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
                fontSize: 30,
                cursor: "pointer",
                boxShadow: selected === i ? "0 0 26px rgba(253,245,230,0.15)" : "none",
        ...
        <svg width={700} height={620} style={{ position: "absolute", top: 0, left: 0, overflow: "visible" }}>
          <path
            ref={arcRef}
            d={arcPath}
            stroke="#fdf5e6"
        ...
        >
          ...
          <div style={{ fontWeight: 700, fontSize: 22, marginTop: 8 }}>{verticals[selected].label}</div>
